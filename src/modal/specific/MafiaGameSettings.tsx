import { Clock, Users, Skull, AlertCircle } from "lucide-react";
    ...
    <div className="space-y-8 animate-in fade-in duration-300">
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-end">
          ...
          <span className="text-lg font-black italic text-purple-400">
            {maxPlayers}명
          </span>
        </div>
        <input
      ...
      <div className="space-y-4">
        <div className="flex justify-between items-center">
          ...
          <div className="relative">
            ...
            >
              {Array.from({ length: maxAllowedMafia }, (_, i) => i + 1).map(
                (num) => (
        ...
        <div className="flex items-start gap-2 p-3.5 bg-red-500/5 border border-red-500/10 rounded-2xl">
          ...
          <p className="text-[10px] text-gray-500 leading-relaxed font-medium">
            게임 밸런스를 위해 마피아는 최대 인원의{" "}
            <span className="text-red-400 font-bold">
              40%({maxAllowedMafia}명)
            </span>
            까지만 설정할 수 있습니다.
          </p>
        </div>
