        ...
        <div className="container mx-auto max-w-5xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-[#121212] rounded-[2.5rem] border border-white/10 p-8 relative overflow-hidden group">
                ...
                <div className="flex flex-col items-center text-center mt-4">
                  <div className="relative mb-6">
                    <div className="w-32 h-32 rounded-[2rem] bg-gradient-to-tr from-purple-500 to-pink-500 p-1">
                      <div className="w-full h-full rounded-[1.8rem] bg-[#1a1a1a] flex items-center justify-center text-5xl overflow-hidden">
                        {user?.profileImage || "👤"}
                      </div>
                    </div>
                    <div className="absolute -bottom-2 -right-2 bg-green-500 w-6 h-6 rounded-full border-4 border-[#121212]"></div>
                  </div>

                  <h2 className="text-2xl font-bold mb-1">
                    {user?.nickname || "Guest"}
                  </h2>
                  <p className="text-purple-400 text-sm font-semibold mb-6 uppercase tracking-wider">
                    Pro Gamer
                  </p>
            ...
            <div className="lg:col-span-2 space-y-8">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                {USER_STATS.map((stat, idx) => (
                  <div
                    key={idx}
                    className="bg-white/5 border border-white/10 rounded-3xl p-6 transition-transform hover:-translate-y-1"
                  >
              ...
              <div className="bg-[#121212] rounded-[2.5rem] border border-white/10 p-8">
                ...
                <div className="space-y-4">
                  {[1, 2, 3].map((_, i) => (
                    <div
                      key={i}
                      className="flex items-center gap-4 p-4 rounded-2xl bg-white/5 border border-white/5 hover:border-white/20 transition-all cursor-pointer group"
                    >
                ...
                <button className="w-full mt-8 py-4 text-sm font-bold text-gray-500 hover:text-white transition-colors border-t border-white/5">
                  SHOW ALL ACTIVITIES
                </button>
              </div>
            </div>
